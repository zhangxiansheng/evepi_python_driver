...
def get_now_res( name ):
    return get_res( name )[ "now_result" ] # return "0" or "1"

def get_now_action( name ):
    return get_res( name )[ "action"]

def get_on_off_status( name ):
    return get_res( name )[ "on_off_status" ] # return 'on' or 'off'
